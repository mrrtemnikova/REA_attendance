    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
		...
		<li class="nav-item">
			...
			<li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="teachers.php">Faculties</a>
            </li>
			<li class="nav-item">
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
			  <div class="brand-heading">
				<div class="row">
					<div class="col-md-6">
						<img style="height: auto;width: 50%;" src="../assets/teacheric.png">
					</div>
					<div class="col-md-6">
						<h1 style="font-size:0.8em; position: relative; top: 40%; transform: translateY(-50%);">Welcome back!</h1>
					</div>
				</div>
			  </div>
              <p class="intro-text" style="font-size: 2em;">One step solution for your class room</p>
            </div>
          </div>
        </div>
      </div>

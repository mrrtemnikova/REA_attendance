  ...
  <div class="row">
    ...
    <form method="post" class="form-horizontal col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Почта</label>
          <div class="col-sm-7">
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Имя пользователя</label>
          <div class="col-sm-7">
      ...
      <label for="input1" class="col-sm-3 control-label">Статус</label>
      <div class="col-sm-7">
        <label>
    ...
    <br>
    <p><strong>Уже имеете аккаунт? <a href="index.php">Войти</a> здесь.</strong></p>

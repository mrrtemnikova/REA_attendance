...
<div class="panel panel-login" style="padding: 3%">
	...
	<div class="row justify-content-center">
		...
		<h1>Студент</h1>
			...
			<input type="submit" class="btn btn-default btn-lg col-md-3" value="Войти" name="login"/><br>
			<a href="index.php"  class="btn btn-default btn-lg col-md-3" ><span class="network-name">&#8635; Назад</span></a>
			</form>
	</div>
</div>
</div>
...
<br><br>
<p><strong>Забыли пароль? <a href="reset.php">Сбросить здесь.</a></strong> </p>

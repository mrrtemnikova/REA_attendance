...
<header>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top " id="mainNav">
      <div class="container ">
		...
		<li class="nav-item">
              <a class="nav-link js-scroll-trigger text-light" href="students.php">Спсиок студентов</a>
            </li>
			<li class="nav-item">
              <a class="nav-link js-scroll-trigger text-light" href="report.php">Посещение</a>
            </li>
			<li class="nav-item">
              <a class="nav-link js-scroll-trigger text-light" href="account.php">Редактировать профиль</a>
            </li>
			<li class="nav-item">
...
<div class="row">
  <div class="content">
   ...
   <form method="post" action="" class="form-horizontal col-md-6 col-md-offset-3">
      ...
      <input type="submit" class="btn btn-primary col-md-3 col-md-offset-7" value="Найти" name="sr_btn" /> 
   </form>
